...
def main(argv=None):
    ap=argparse.ArgumentParser(); ap.add_argument('--config',required=True); ap.add_argument('--dry-run',action='store_true'); ap.add_argument('--run',action='store_true'); ap.add_argument('--limit_pairs',type=int,default=0); ap.add_argument('--max_steps',type=int,default=0); ap.add_argument('--passk_report',default=''); a=ap.parse_args(argv)
