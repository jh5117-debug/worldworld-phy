...
REQUIRED_FILES = (
    ...
    "scripts/migration/validate_physeditworld_root_submission.sh",
    "scripts/migration/sample_physeditworld_root_evidence.sh",
    "scripts/migration/run_physeditworld_root_onboarding_sequence.sh",
    "scripts/migration/write_physeditworld_external_root_handoff_packet.sh",
    "scripts/migration/watch_physeditworld_external_state.sh",
    ...
    "cam_physgeo/orchestration/physeditworld_root_submission_validate.py",
    "cam_physgeo/orchestration/physeditworld_root_evidence_sampler.py",
    "cam_physgeo/orchestration/physeditworld_root_onboarding_sequence.py",
    "cam_physgeo/orchestration/physeditworld_external_root_handoff_packet.py",
    "cam_physgeo/orchestration/physeditworld_external_state_watch.py",
