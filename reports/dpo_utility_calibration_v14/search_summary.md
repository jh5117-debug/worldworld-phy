...
- `E05_screen5`: objective=`normalized_clipped_loser`, steps=`5`, training=`TRAINING_SIGNAL_PASS`, video=`VISUAL_GATE_FAIL_FINAL_CHECKPOINT_WORSE`, final_winner=`0.00012230873107910156`

Current decision: `DPO_RECIPE_NOT_FOUND_V14`. E05 is the best actual DPO-like candidate on training gaps so far, but its checkpoint video gate fails because 2/4 audited samples get worse at step005. Train400/S32/S64 remain blocked.
