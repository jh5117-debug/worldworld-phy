...
- `backend_readiness`: `BLOCKED` / `PHYS_EDITWORLD_BACKEND_BLOCKED_SCAFFOLD_ONLY`
  ...
  - command: `python3 -m cam_physgeo.orchestration.physeditworld_backend_readiness`
...
- `physeditworld_external_unblock_packet`: `BLOCKED` / `PHYS_EDITWORLD_EXTERNAL_UNBLOCK_REQUIRED_NAS_OR_ROOT`
  - evidence: `reports/migration/physeditworld_external_unblock_packet.json`
  - command: `bash scripts/migration/write_physeditworld_external_unblock_packet.sh`
