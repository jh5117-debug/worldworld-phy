...
Generated: 2026-07-07T02:55:06.327096

Decision: DPO_RECIPE_NOT_FOUND.

Correction: S10 wrote a 100step CSV with 18 rows. Its final winner_improvement_post was negative and DPO loss stayed near 0.693, so it is classified as a signal failure rather than a zero-row runtime-only failure.
...
| S10_lora_camera_temporal_winner_detached | lora_camera_temporal_winner_detached | L2_camera_temporal_r4 | 18 | 6.01411e-05 | -0.000106275 | 0.616615 | 0.159531 | 0.693146 | DPO_RECIPE_TRAINING_SIGNAL_FAIL_WINNER_FINAL_NEGATIVE |

## Next Step

Do not run train400. Next work should calibrate preference utility/gap scale offline before further DPO training.
