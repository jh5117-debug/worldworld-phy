...
Generate clearer V2V-5 rollout candidates for Type B medium-hard losers using conservative small-LoRA scopes, only when GPUs are available.
...
- Primary output root: `reports/candidate_generator_v2/`.
