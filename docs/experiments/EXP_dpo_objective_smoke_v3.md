...
Run only a tiny engineering smoke with SDPO-anchor v2 after Protocol v3 and mask gates pass; do not scale DPO.
...
- Primary output root: `reports/dpo_objective_smoke_v3/`.
