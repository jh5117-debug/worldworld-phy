...
Determine whether real FVD and VBench can be enabled locally without fabricating metrics or downloading uncontrolled large assets.
...
- Primary output root: `reports/metrics_backend_readiness_v2/`.
