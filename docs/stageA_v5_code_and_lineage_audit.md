...
Training source checkpoint is `/home/nvme03/workspace/lingbot-world/lingbot-world-base-cam`, loaded as the LingBot camera MoE Stage1 source model. This is not used as a DPO teacher and no Base preference training is run. LingBot runtime code resolves to `/home/nvme03/workspace/world_model_phys/code/lingbot-world`.
