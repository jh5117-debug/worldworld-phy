...
def test_sample_schema_and_reward_stub():
    sample = normalize_sample({'sample_id': 's1', 'source': 'phyinone', 'template': 'drop', 'camera_motion': 'static'})
...
def test_preference_schema():
    pair = {'pair_id': 'p1', 'condition': {}, 'winner': {'video': 'a.mp4'}, 'loser': {'video': 'b.mp4'}, 'pair_type': 'gt_vs_corrupt', 'margin': 1.0, 'quality_flags': []}
