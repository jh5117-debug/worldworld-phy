...
def test_required_files_include_latest_handoff_tools():
    ...
    assert "scripts/migration/watch_physeditworld_external_state.sh" in required
    ...
    assert "cam_physgeo/orchestration/physeditworld_external_state_watch.py" in required
...
def test_expected_reports_include_root_lock_completion_audit_and_restore_packet():
    ...
    assert "reports/migration/physeditworld_external_state_watch.json" in expected
